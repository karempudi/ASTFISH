...
def iou_width_height(boxes1, boxes2):
    ...
    """
    Parameters:
        Used for just arrays of width and heights when you know that the boxes have 
        the same center
...
def plot_image(image, boxes, classes=PASCAL_CLASSES):
...
def get_evaluation_bboxes(loader, model, iou_threshold, anchors,
...
def plot_couple_examples(model, loader, thresh, iou_thresh, anchors, device="cuda:0"):
    model.eval()
